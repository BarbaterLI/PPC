...
class AnalysisDiffer:
    ...
    def compare(self, current: HealthReport, previous: HealthReport) -> DiffResult:
        ...
        previous_by_desc: dict[str, AnalysisIssue] = {issue.description: issue for issue in previous.issues}
        current_by_desc: dict[str, AnalysisIssue] = {issue.description: issue for issue in current.issues}
        ...
        persistent_issues = [current_by_desc[desc] for desc in sorted(persistent_descriptions)]
