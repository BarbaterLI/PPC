...
class TTSClientError(TTSError):
    ...
    All errors raised by :class:`src.engines.edge_tts_client.EdgeTTSClient`
...
class NetworkError(TTSClientError):  # type: ignore[no-redef]  # noqa: F811  # 与上方 NetworkError 重名，但属于不同错误层级，保留运行时名称
