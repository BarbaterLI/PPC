...
def get_rule(name: str) -> NormalizerRule | None:
...
class RuleChain:
    ...
    def __init__(self, rule_names: list[str] | None = None) -> None:
        if rule_names is None:
            ...
            self._rules = [_RULE_REGISTRY[name] for name in rule_names if name in _RULE_REGISTRY]
...
class TextNormalizer:
    ...
    def set_empty_line_normalization(self, enabled: bool, max_lines: int | None = None) -> None:
