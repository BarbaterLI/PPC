...
class QuarantineQueue:
    ...
    def __init__(self, delay: float = 300.0, max_failure_count: int = 3, capacity_ratio: float = 0.1):
        self._delay = delay
    ...
    def add_quarantine(self, task_id: str, task_data: dict[str, Any], failure_count: int, total_tasks: int) -> bool:
        """将任务加入隔离队列
    ...
    def remove_task(self, task_id: str) -> QuarantinedTask | None:
        """移除任务
    ...
    def get_task(self, task_id: str) -> QuarantinedTask | None:
        """获取任务
