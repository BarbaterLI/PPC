...
from src.extensions.base import Extension, ExtensionMetadata, ExtensionType, LoadBalanceStrategy


class PriorityBasedStrategy(Extension, LoadBalanceStrategy):
