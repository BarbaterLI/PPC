export type AnalysisCategory = 'performance' | 'memory' | 'reliability' | 'configuration' | 'security' | 'dependency' | 'code_quality' | 'resource' | 'network' | 'unknown';
...
export type ExtensionType = 'load_balance_strategy' | 'health_check_strategy' | 'task_scheduling_strategy' | 'metrics_exporter' | 'executor' | 'tool_integration';
...
export type { PipelineStep, PipelineDefinition, PipelineInfo, StepResult, PipelineRun, StepType, } from './pipeline';
