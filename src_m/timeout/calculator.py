...
class TimeoutConfig:
    ...
    task_type_factors: Dict[str, float] = field(default_factory=lambda: {
        "tts": 1.5,
        "voice_clone": 2.0,
        "transcription": 1.2,
    })
...
class TimeoutCalculator:
    ...
    def calculate(
        ...
        """
        complexity_timeout = self._calculate_complexity_timeout(
            task_type, text_length, audio_duration
        )
...
def get_calculator(config: Optional[TimeoutConfig] = None) -> TimeoutCalculator:
