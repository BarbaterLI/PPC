...
class FanqieExtension(Extension, ToolIntegration):
    ...
    def register_cli(self, app: typer.Typer) -> None:
        ...
        def fanqie_tui(
            ...
            console.print(
                f"[{BrandColors.INFO}]{Icons.ROCKET} 正在启动番茄小说下载器TUI...[/{BrandColors.INFO}]"
            )
        ...
        def fanqie_server(
            ...
            console.print(
                f"[{BrandColors.INFO}]{Icons.ROCKET} 正在启动番茄小说下载器Server...[/{BrandColors.INFO}]"
            )
        ...
        def fanqie_status():
            ...
            console.print(f"[bold]番茄小说下载器状态[/bold]\n")
            ...
            if status["installed"]:
                ...
                if update_available is True:
                    ...
                    console.print(f"  更新命令: ppc10 ext call fanqie_downloader update")
                ...
                console.print(f"  安装命令: ppc10 ext call fanqie_downloader install")
        ...
        def fanqie_config(
            ...
            if action == "show":
                ...
                if content is None:
                    ...
                    console.print("[dim]      也可通过 ppc10 ext call fanqie_downloader config set -k <key> -v <value> 创建[/dim]")
                else:
                    console.print(f"[bold]番茄小说下载器配置[/bold]")
