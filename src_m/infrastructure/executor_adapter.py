...
if TYPE_CHECKING:
    from src_m.infrastructure.processing_unit import MasterUnit
...
class DistributedTTSExecutor:
    ...
    def __init__(
        ...
        self._master: Optional["MasterUnit"] = None
    ...
    async def initialize(self):
        ...
        from src_m.infrastructure.processing_unit import MasterUnit, UnitRole
    ...
    async def submit_convert_request(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from src_m.infrastructure.processing_unit import ConvertRequest, ConvertResult
